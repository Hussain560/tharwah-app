...
const resources = {
  ...
  // SAR icon is now used everywhere instead of the text 'SAR'.
      ...
      diversifiedGrowthFund: 'Diversified Growth Fund',
      greenEnergyPortfolio: 'Green Energy Portfolio',
      techInnovationFund: 'Tech Innovation Fund',
      projectedReturn: 'Projected Return',
      viewDetails: 'View Details',
      startInvesting: 'Start Investing',
      smartInvestmentDesc: 'Let AI guide your investment decisions with personalized recommendations.',
      balancedPortfolio: 'Balanced portfolio with steady growth potential',
      sustainableInvestments: 'ESG-focused investments in renewable energy',
      highGrowthTech: 'High-growth technology companies and startups',
      ...
      aiAnalysisFollowUp: "I understand you'd like to discuss your spending analysis further. Based on your dining expenses being higher than average, I can help you create a plan to reduce those costs. What specific aspect would you like to focus on?",
  ...
  ar: {
    translation: {
      ...
      smartInvestment: 'الاستثمار الذكي',
      loyaltyPoints: 'نقاط الولاء',
      
      // Smart Investment Screen
      investmentGoal: 'هدف الاستثمار',
      ...
      diversifiedGrowthFund: 'صندوق النمو المتنوع',
      greenEnergyPortfolio: 'محفظة الطاقة الخضراء',
      techInnovationFund: 'صندوق الابتكار التقني',
      projectedReturn: 'العائد المتوقع',
      viewDetails: 'عرض التفاصيل',
      startInvesting: 'ابدأ الاستثمار',
      smartInvestmentDesc: 'دع الذكاء الاصطناعي يوجه قرارات استثمارك بتوصيات مخصصة.',
      balancedPortfolio: 'محفظة متوازنة مع إمكانية نمو ثابتة',
      sustainableInvestments: 'استثمارات مركزة على البيئة في الطاقة المتجددة',
      highGrowthTech: 'شركات التكنولوجيا عالية النمو والشركات الناشئة',
      investmentHistory: 'تاريخ الاستثمار',
      date: 'التاريخ',
      investment: 'الاستثمار',
      performance: 'الأداء',
      investNow: 'استثمر الآن',
      discussWithAi: 'ناقش مع الذكاء الاصطناعي',
      aiAnalysisFollowUp: 'أفهم أنك تريد مناقشة تحليل إنفاقك بشكل أكثر تفصيلاً. بناءً على أن مصاريف الطعام لديك أعلى من المتوسط، يمكنني مساعدتك في وضع خطة لتقليل هذه التكاليف. ما الجانب المحدد الذي تريد التركيز عليه؟',
